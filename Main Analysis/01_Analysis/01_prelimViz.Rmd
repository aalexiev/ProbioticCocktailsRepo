...
curvijliv_fill <- c("Live Bd control", "Curvibacter sp. CFS treatment", "J. lividum CFS treatment", "Curvibacter sp. and J. lividum\ncombined CFS treatment")
curvijliv_labels <- c("Live Bd control", "Curvibacter sp. CFS treatment\nplus\nJ. lividum CFS treatment", "Curvibacter sp. CFS treatment\nplus\nJ. lividum CFS treatment", "Curvibacter sp.\nand J. lividum\ncombined CFS treatment")
curvijliv_levels <- c("Live Bd control", "Curvibacter sp. CFS treatment\nplus\nJ. lividum CFS treatment", "Curvibacter sp.\nand J. lividum\ncombined CFS treatment")
...
curvijliv_graphas <- ggplot(cfs_as_graphdf, aes(fill = factor(curvijliv_fill,
 ...
 #   coord_cartesian(ylim = c(-0.1, 4)) +
    ylab("Difference in Bd growth from live Bd \ncontrol at time 100 hrs (mean live Bd OD minus mean CFS treatment OD)") 
curvijliv_graphas
# save graph
...
curvichryseo_fill <- c("Live Bd control", "Curvibacter sp. CFS treatment", "Chryseobacterium sp. CFS treatment", "Curvibacter sp. and Chryseobacterium sp.\ncombined CFS treatment")
curvichryseo_labels <- c("Live Bd control", "Curvibacter sp. CFS treatment\nplus\nChryseobacterium sp. CFS treatment", "Curvibacter sp. CFS treatment\nplus\nChryseobacterium sp. CFS treatment", "Curvibacter sp.\nand Chryseobacterium sp.\ncombined CFS treatment")
curvichryseo_levels <- c("Live Bd control", "Curvibacter sp. CFS treatment\nplus\nChryseobacterium sp. CFS treatment", "Curvibacter sp.\nand Chryseobacterium sp.\ncombined CFS treatment")
...
chryseojliv_fill <- c("Live Bd control", "Chryseobacterium sp. CFS treatment", "J. lividum CFS treatment", "Chryseobacterium sp. and J. lividum\ncombined CFS treatment")
chryseojliv_labels <- c("Live Bd control", "Chryseobacterium sp. CFS treatment\nplus\nJ. lividum CFS treatment", "Chryseobacterium sp. CFS treatment\nplus\nJ. lividum CFS treatment", "Chryseobacterium sp.\nand J. lividum\ncombined CFS treatment")
chryseojliv_levels <- c("Live Bd control", "Chryseobacterium sp. CFS treatment\nplus\nJ. lividum CFS treatment", "Chryseobacterium sp.\nand J. lividum\ncombined CFS treatment")
...
model_fill <- c("Live Bd control", "Bacteria 1 CFS treatment", 
                "Bacteria 2 CFS treatment", 
                "Bacteria 1 and Bacteria 2\ncombined CFS treatment",
                "Bacteria 1 and Bacteria 2\ncombined CFS treatment",
                "Bacteria 1 and Bacteria 2\ncombined CFS treatment")
model_fill_levels <- c("Live Bd control", "Bacteria 1 CFS treatment", 
                "Bacteria 2 CFS treatment", 
                "Bacteria 1 and Bacteria 2\ncombined CFS treatment")
model_labels <- c("Live Bd control", 
                  "Bacteria 1 CFS treatment\nplus\nBacteria 2 treatment", 
                  "Bacteria 1 CFS treatment\nplus\nBacteria 2 treatment", 
                  "Bacteria 1\nand Bacteria 2\ncombined CFS treatment\n(Additive inhibition example)", 
                  "Bacteria 1\nand Bacteria 2\ncombined CFS treatment\n(Synergistic inhibition example)", 
                  "Bacteria 1\nand Bacteria 2\ncombined CFS treatment\n(Antagonistic inhibition example)")
model_levels <- c("Live Bd control", 
                  "Bacteria 1 CFS treatment\nplus\nBacteria 2 treatment", 
                  "Bacteria 1\nand Bacteria 2\ncombined CFS treatment\n(Additive inhibition example)", 
                  "Bacteria 1\nand Bacteria 2\ncombined CFS treatment\n(Synergistic inhibition example)", 
                  "Bacteria 1\nand Bacteria 2\ncombined CFS treatment\n(Antagonistic inhibition example)")
